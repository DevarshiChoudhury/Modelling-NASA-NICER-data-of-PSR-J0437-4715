""" Instrument module for X-PSI ST+PDT + NSX-H modelling of NICER PSR J0437-4715 event data. """
...
class CustomInstrument(xpsi.Instrument):
    ...
    def XTI(cls,
        ...
        RSP = np.loadtxt(RMF, dtype=np.double, skiprows=RMF_skiprows, usecols=RMF_usecol)
        ...
        for i in range(ARF.shape[0]):
            matrix[:,i] = RSP[i*channel_energies.shape[0]:(i+1)*channel_energies.shape[0]]
