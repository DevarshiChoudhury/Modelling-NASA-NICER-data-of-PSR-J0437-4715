""" Photosphere module for X-PSI ST+PDT modelling of NICER PSR J0437-4715 event data. """
...
parser = ArgumentParserCustom(
    description="""
    Photosphere module for X-PSI ST+PDT + NSX-H modelling of NICER PSR J0437-4715 event data.
...
class CustomPhotosphere(xpsi.Photosphere):
    ...
    def global_variables(self):
        ...
        return np.array([ref_p['omit_colatitude'],
                          ...
                          (ref_s['phase_shift'] + 0.5) * 2.0 * math.pi,
                          ref_s['super_radius'],
                          ref_s['cede_colatitude'],
                          (ref_s['phase_shift'] + 0.5) * 2.0 * math.pi + ref_p['cede_azimuth'],
                          ref_s['cede_radius'],
                          0.0,
