...
print("\n3C50_BKG_lower_smooth_3sigma module loaded \n")

from _auto_modules import main_3C50_BKG_AGN_smooth_3sigma
print("\n3C50_BKG_AGN_smooth_3sigma log-likelihood value: ",
      main_3C50_BKG_AGN_smooth_3sigma.likelihood(main_3C50_BKG_AGN_smooth_3sigma.p_maxL, reinitialise=True))
print("\n3C50_BKG_AGN_smooth_3sigma module loaded \n")
...
ST_PDT_bounds = {'mass': main_3C50_NoBKG.likelihood.get_param('mass').bounds,
...
main_3C50_NoBKG.bounds = ST_PDT_bounds
main_3C50_NoBKG.labels = ST_PDT_labels
...
main_3C50_BKG_lower_smooth_3sigma.bounds = ST_PDT_bounds
main_3C50_BKG_lower_smooth_3sigma.labels = ST_PDT_labels
...
main_3C50_BKG_AGN_smooth_3sigma.bounds = ST_PDT_bounds
main_3C50_BKG_AGN_smooth_3sigma.labels = ST_PDT_labels
