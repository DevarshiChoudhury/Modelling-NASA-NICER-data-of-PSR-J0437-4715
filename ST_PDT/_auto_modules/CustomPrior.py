""" Prior module for X-PSI ST+PDT modelling of NICER PSR J0437-4715 event data. """
...
class CustomPrior(xpsi.Prior):
    ...
    def __call__(self, p = None):
        ...
        if self._overlap(ref, 'p', 's', 'super', 'super', 0.0, 0.5):
            return -np.inf

        if self._overlap(ref, 'p', 's', 'super', 'cede', 0.0, 0.5):
            return -np.inf
