""" Main module for NICER PSR J0437-4715 <- X-PSI 2.1.1 ST+PDT"""
import os
import argparse
import re
...
parser = ArgumentParserCustom(
    description="""
    Main module for X-PSI ST+PDT modelling of NICER PSR J0437-4715 event data.

    You can run this module as a script and launch a sampler, optionally
    with a world of MPI processes.

    Alternate usage: mpiexec -n 4 python -m mpi4py %(prog)s [-h] @<config_3C50_BKG_AGN.ini>
...
# Maximum likelihood vector from MultiNest output files
p_maxL = [0.146338538212781177E+01,
          0.987113097755463542E+01,
         -0.737045117649129722E+00,
         -0.223643334013295114E-01,
          0.557577965769638584E+00,
          0.988843580696514290E-01,
          0.620968236543795626E+01,
          0.726466381930753080E+00,
          0.284138068482679129E+01,
          0.110966784052049395E-01,
          0.641245044054792768E+01,
          0.298496084185956123E+01,
          0.233667448565385127E+00,
         -0.423783704979933340E+00,
          0.580828858087737299E+01,
          0.100624558708142176E+01,
          0.343337584647059810E-01]
