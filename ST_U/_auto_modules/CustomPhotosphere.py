""" Photosphere module for X-PSI ST-U modelling of NICER PSR J0437-4715 event data. """
...
class CustomPhotosphere(xpsi.Photosphere):
    ...
    def global_variables(self):
        ...
        return np.array([ref_p['omit_colatitude'],
                          ...
                          ref_p['super_radius'],
                          ref_s['omit_colatitude'],
                          (ref_s['phase_shift'] + 0.5) * 2.0 * math.pi,
                          ref_s['omit_radius'],
                          ref_s['super_colatitude'],
                          (ref_s['phase_shift'] + 0.5) * 2.0 * math.pi - ref_p['omit_azimuth'],
                          ref_s['super_radius'],
                          0.0,
