...
class CustomPrior(xpsi.Prior):
    ...
    * p[12] = hydrogen column density (10^20 cm^-2)
    ...
    def __init__(self):
        ...
        self._distance = truncnorm.ppf(uniform_sampler2, -3.0, 3.0, loc=0.15701, scale=0.001)
        ...
        self._beta_cdf = np.array(list(range(len(self._ordered_beta))))/float(len(self._ordered_beta))
