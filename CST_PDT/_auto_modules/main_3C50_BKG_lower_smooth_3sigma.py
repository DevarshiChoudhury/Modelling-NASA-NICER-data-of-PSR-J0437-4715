...
class GenerateConfigAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        with open('./config_3C50_BKG_lower.ini', 'w') as file:
...
if __name__ == '__main__':
    ...
    if xpsi._verbose:
        print('Parsing configuration file...')
    args, _ = parser.parse_known_args(['@./config_3C50_BKG_lower.ini'])
    if xpsi._verbose:
        print('Configuration file parsed.')
...
if args.XTI_background_prior_support_path:
    ...
    support[:,0] = spectrum_smooth - 3.0*err
...
p_maxL = [0.144291557347596422E+01,
          0.103393894708481433E+02,
         -0.736336021345418756E+00,
         -0.117514437923684767E-01,
          0.209713842390157473E+00,
          0.326520221677246092E+00,
          0.616612340470111420E+01,
          0.550897649447094767E-01,
         -0.163356418367042344E+00,
          0.263106636265609861E+01,
          0.115024696550190594E-01,
          0.638266436109984436E+01,
          0.262139836798000392E+01,
          0.155411197312874894E+00,
         -0.304373680717029416E+00,
          0.575614572113560552E+01,
          0.871250675008731101E+00,
          0.643955918469180377E-01]
