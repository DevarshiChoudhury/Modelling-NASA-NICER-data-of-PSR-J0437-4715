...
class GenerateConfigAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        with open('./config_3C50_NoBKG_NoRadio.ini', 'w') as file:
...
if __name__ == '__main__':
    ...
    if xpsi._verbose:
        print('Parsing configuration file...')
    args, _ = parser.parse_known_args(['@./config_3C50_NoBKG_NoRadio.ini'])
    if xpsi._verbose:
        print('Configuration file parsed.')
...
if __name__ == '__main__':
    from CustomInstrument_NoRadio_beta_param import CustomInstrument
    ...
    from CustomPrior_NoRadio_beta_param import CustomPrior
...
bounds = dict(energy_independent_effective_area_scaling_factor = parse_bounds(args.XTI_energy_independent_effective_area_scaling_factor_bounds,
                                   ...
                                   default_to_free = True))    # Changed arg to true so that it takes default bounds of combined scaling param
...
p_maxL = [0.104328006318531852E+01,
          0.964536417962874104E+01,
         -0.881718767950777860E+00,
          0.364748218491895981E+00,
          0.597627385650621040E-01,
          0.796992037293637212E+00,
          0.618702449290343459E+01,
          0.712183773734490488E+00,
          0.461327461188334231E+00,
          0.155222886738662424E+01,
          0.426604217749392695E-01,
          0.623552738115223271E+01,
          0.117664061346413940E+01,
          0.393890612436819942E+00,
          0.228494730061868351E+00,
          0.576158551430529808E+01,
          0.375536740621918739E+02,
          0.101722643356962905E+01]
