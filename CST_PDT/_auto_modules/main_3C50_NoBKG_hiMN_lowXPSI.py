...
class GenerateConfigAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        with open('./config_3C50_NoBKG_hiMN_lowXPSI_res.ini', 'w') as file:
...
if __name__ == '__main__':
    ...
    if xpsi._verbose:
        print('Parsing configuration file...')
    args, _ = parser.parse_known_args(['@./config_3C50_NoBKG_hiMN_lowXPSI_res.ini'])
    if xpsi._verbose:
        print('Configuration file parsed.')
...
p_maxL_lowMN_hiXPSI_res = [0.140920255753444557E+01,
                           0.107429406819282498E+02,
                          -0.737755789968774556E+00,
                           0.102460779410978864E-02,
                           0.196608435151195138E+00,
                           0.403029759368385865E+00,
                           0.614318902180697535E+01,
                           0.219454331802355108E-01,
                          -0.148368035647668678E+00,
                           0.157834787529801024E+01,
                           0.755582630246758122E-02,
                           0.641716546970603119E+01,
                           0.156395460120392604E+01,
                           0.102727297283225938E+00,
                          -0.102226711396571801E+00,
                           0.580259353625283048E+01,
                           0.785236960618934665E+00,
                           0.528262908504286074E-01]
