""" Prior module for X-PSI CST+PDT modelling of NICER PSR J0437-4715 event data. """
...
class CustomPrior(xpsi.Prior):
    ...
    def __init__(self):
        ...
        self._distance = truncnorm.ppf(uniform_sampler2, -3.0, 3.0, loc=0.15698, scale=0.00016)
        ...
        self.interpolator_beta = Akima1DInterpolator(self._beta_cdf, self._ordered_beta)
        self.interpolator_beta.extrapolate = True

        self.a_f = 0.001
        self.b_f = 1.0
        self.a_zeta = 0.001
        self.b_zeta = math.pi/2 - self.a_zeta
    ...
    def transform(self, p, **kargs):
        ...
        # N_H in units of 10^20 cm^-2
        p += [ref['neutral_hydrogen_column_density']*0.4]

        # shifting phase shift intervals
