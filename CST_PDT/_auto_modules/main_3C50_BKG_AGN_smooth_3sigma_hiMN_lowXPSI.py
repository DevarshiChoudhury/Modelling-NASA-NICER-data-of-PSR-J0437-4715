""" Main module for NICER PSR J0437-4715 <- X-PSI 2.1.1 CST+PDT"""
import os
import argparse
import re
...
class GenerateConfigAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        with open('./config_3C50_BKG_AGN_hiMN_lowXPSI_res.ini', 'w') as file:
...
parser = ArgumentParserCustom(
    description="""
    Main module for X-PSI CST+PDT modelling of NICER PSR J0437-4715 event data.
...
parser.add_argument('--AGN-path', type=str, help='Absolute or relative path to AGN estimates', comment_line_above='rule')
...
if __name__ == '__main__':
    ...
    if xpsi._verbose:
        print('Parsing configuration file...')
    args, _ = parser.parse_known_args(['@./config_3C50_BKG_AGN_hiMN_lowXPSI_res.ini'])
    if xpsi._verbose:
        print('Configuration file parsed.')
...
p_maxL_lowMN_hiXPSI_res = [0.138690984149669916E+01,
                           0.106875824187030908E+02,
                          -0.736903085394852164E+00,
                           0.439757361905855793E+00,
                           0.139155561837880276E+00,
                           0.413860205729086217E+00,
                           0.610490039559902620E+01,
                           0.968921710918149576E-01,
                           0.470491811937420401E+00,
                           0.230083700984559014E+01,
                           0.299916256745280593E-01,
                           0.622391566114107864E+01,
                           0.218433044622659667E+01,
                           0.188235842166197209E+00,
                          -0.796185862291309832E-02,
                           0.577031499445387031E+01,
                           0.113427195974932848E+01,
                           0.184694358624374125E-01]

p_maxL_hiMN_lowXPSI_res = [0.138768656564593451E+01,
                           0.131704786246932404E+02,
                          -0.737614949189869251E+00,
                           0.438068149662676820E+00,
                           0.111862088107257215E+00,
                           0.561142968192882785E+00,
                           0.607538640960972209E+01,
                           0.336108729363516101E+00,
                           0.466027375159602353E+00,
                           0.239164312406114954E+01,
                           0.267652378206386897E-01,
                           0.619901597626930556E+01,
                           0.231803391947134063E+01,
                           0.176707597105723924E+00,
                           0.120545428578139151E-01,
                           0.572406172022289539E+01,
                           0.979064416553833361E+00,
                           0.536110001646976017E-01]
